...
<section class="relative overflow-hidden bg-ice">
  ...
  <div class="pointer-events-none absolute inset-0 bg-gradient-to-br from-ice via-white/60 to-[#d4ebf8]"></div>

  <div class="relative mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 py-16 sm:px-6 md:flex-row md:py-24 lg:py-28">
    ...
    <div class="flex-1 text-center md:text-left">
      ...
      <h1 class="text-4xl font-extrabold leading-tight tracking-tight text-navy sm:text-5xl lg:text-6xl">
...
<section class="bg-navy py-20">
  <div class="mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 sm:px-6 lg:flex-row lg:gap-16">
